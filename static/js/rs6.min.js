            ...
            case "init":
              if (
                ...
                punchgs.TweenMax.set(
                  ...
                  e(document).on("RS_OPENMODAL_" + i[r].modal.alias, function (
                    e,
                    t
                  ) {
  ...
  var r = i.is_mobile(),
    ...
    h = function (a) {
      if (i[a] !== t) {
        ...
        for (var d in ((i[a].slides = i[a].canvas[0].getElementsByTagName(
          "rs-slide"
        )),
        ...
        if (
          ...
          i[a].c[0].classList.add("revslider-initialised"),
            ...
            (i[a].rs_static_layer = i[a].c[0].getElementsByTagName(
              "rs-static-layers"
            )),
  ...
  (function (e) {
    ...
    jQuery.extend(!0, t, {
      prepareCarousel: function (e, o, n, l) {
        void 0 !== e &&
          ((n = t[e].carousel.lastdirection = r(
            n,
